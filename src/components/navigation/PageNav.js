    ...
    <div className="Main-nav-img"><Link to="/"><img src="images/MIGdevelopment.png"/></Link></div>
     <nav className="nav-test-bar">
      <ul>
          ...
          <li><a href="files-dwnl/Golovin_Ivan_Resume.png" download="Resume_Ivan_Golovine" title="Open Resume as PDF"><img id="download-b" className="nav-test-download-glow" src="images/cloud-arrow-down-solid.svg"/></a></li>
      </ul>
    </nav>
    </div>
  );
